...
public class CAP018 extends BasePage {
	...
	public CAP018(WebDriver driver, String dataFileName) {
		super(driver);
		this.driver = driver;
		initElements();
	...
	public CAP018 simpleBooking(String prefix, String awbno, String origin, String dest, String agentCode,
		 ...
		 */
		click(btn_List);
		InitialSetup.test.log(LogStatus.INFO, "Started with the booking process");
		minWait();
		driver.switchTo().defaultContent();
		if (verifyElementPresent(info_msg)
		...
		InitialSetup.test.log(LogStatus.INFO, "Entered all the shipment details");
		enterKeys(list_txt_fltOrigin, origin);
		enterKeys(list_txt_fltDest, dest);
		...
		InitialSetup.test.log(LogStatus.INFO, "Entered the flight details");
		InitialSetup.
		/*
		...
		continueEmbargo();
		InitialSetup.test.log(LogStatus.INFO, "Saved all the booking details");
		// maxWait();
		// maxWait();
		maxWait();
		...
		if (!ubrNo.equals(null) || !awb.equals(null)) {
			InitialSetup.test.log(LogStatus.PASS, "Successfully booked with AWB No: " + awb + " and UBR No: " + ubrNo);
	...
	public CAP018 writeDatatoPropertyfile(String Path, String prefix, String awbno, String origin, String dest,
		...
		InitialSetup.test.log(LogStatus.INFO, "Started writing the data to property file");
		CarrierCode = PropertyHandler.getPropValue(dataFilePath, CarrierCode);
		prefix = PropertyHandler.getPropValue(dataFilePath, prefix);
		FlightNo = PropertyHandler.getPropValue(dataFilePath, FlightNo);
		awbno = PropertyHandler.getPropValue(dataFilePath, awbno);
		...
		// uldNo);
		InitialSetup.test.log(LogStatus.INFO, "Data successfully written to the property file");
		return this;
	...
	/**
	 * close and navigate to CAP027 screen
	 * 
	 * @return
	 * @author A-7681
	 */
	public CAP027 closeToCAP027() {
		...
		waitForFrameAndSwitch(screenName);
		return new CAP027(driver, dataFileName);
	}

	/**
	 * close and navigate to CAP016 screen
	 * 
	 * @return
	 * @author A-7681
	 */
	public CAP016 closeToCAP016() {
	...
	/**
	 * close and navigate to CAP142 screen
	 * 
	 * @return
	 * @author A-7868
	 */
	public CAP142 closeToCAP142() {
	...
	public CAP018 reassignFlight(String awbPre, String awb, String flightNo, String flightDate, String pcs,
		...
		click(btn_List);
		minWait();
		enterKeys(txt_shippingDt, flightDate);
		enterKeys(txt_product, "");
		enterKeys(list_txt_fltNo, flightNo);
		...
		waitForNewWindow(2);
		switchToSecondWindow();
		enterKeys(Irregularity_Inbx_irregularityCode, "Flight Cancellation");
		enterKeys(Irregularity_Inbx_pcs, pcs);
		enterKeys(Irregularity_Inbx_pcs, Keys.TAB);
		// enterKeys(Irregularity_Inbx_weight, weight);
		enterKeys(Irregularity_Inbx_irregularityRemarks, "Flight Cancelled");
		click(Irregularity_Btn_OKbutton);
		switchToFirstWindow();
		waitForNewWindow(2);
		switchToSecondWindow();
	...
	public CAP103 goToBookingHistoryScreen(String awbPre, String awbNo) {
	...
	public TRF017 SpotRateRequest() {
		click(btn_ratingTab);
		minWait();
		click(btn_requestSpotRate);
	 ...
	 * A-8255
	 */
	public TRF017 Booking(String ratingtotalcharge, String stockType, String awbPre, String awb, String origin,
			String dest, String agentCode, String commCode, String pcs, String wt, String vol, String fltNo,
			String fltDt, String ubr, String bookingType, String FullawbNo) {
		...
		click(btn_ratingTab);
		String totalcharge = waitForElementVisible(txt_totalcharge).getText();
		PropertyHandler.setPropValue(dataFilePath, ratingtotalcharge, totalcharge);
		// save(ubr);
		click(btn_spotrate);
		return new TRF017(driver, dataFileName);
	}
	...
	public CAP018 VerifyFlightNos(String CarrierCode, String FlightNo) {
		...
		InitialSetup.test.log(LogStatus.PASS, "Carrier code and Flight no are matching");
		return this;
	}
	...
	public CAP018 getPIDValue() {
		...
		InitialSetup.test.log(LogStatus.PASS, "Successfully taken PID from the format" + exppidno);
		return this;
	}
	...
	public CAP018 simpleHVBookingwithDVandInsurance(String prefix, String awbno, String origin, String dest,
		...
		InitialSetup.test.log(LogStatus.INFO, "Successfully Entered DV Amount:" + DVAmt + "\n\t" + "Insurance: "
				+ Insurance + "\n\t" + "Customs: " + customs);
	...
	public CAP018 HVBookingwithDVandInsurance(String prefix, String awbno, String origin, String dest, String agentCode,
		...
		click(btn_List);
		minWait();
		InitialSetup.test.log(LogStatus.INFO, "Clicked List Button in CAP018 screen");
		 ...
		 * selectByText(list_dropDown_fltForce, forceStatus);
		 */
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered the shipment details");
	...
	public CAP018 simpleBookingwithoutULD(String prefix, String awbno, String origin, String dest, String agentCode,
		 ...
		 * selectByText(list_dropDown_fltForce, forceStatus);
		 */
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered Flight Number: " + carrierWithFlightno);
		return this;
	}
	 ...
	 * @date 30-01-2019
	 */
	public CAP018 saveInCAP018AndVerifyUBRnStatusDirect(String awbno, String commCode) {
//		awbno = PropertyHandler.getPropValue(dataFilePath, awbno); 
		commCode = PropertyHandler.getPropValue(dataFilePath, commCode); 
		click(btn_save);
		// try{
...
//		maxWait();
		...
		if (verifyElementPresent(btn_genericYes)) {
			click(btn_genericYes);
			String msg = waitForElement(info_msg).getText();
			InitialSetup.test.log(LogStatus.INFO, "Clicked Yes on Popup : " + msg);
		...
		if (waitForElement(info_bookingStatus).getAttribute("value").equalsIgnoreCase("CONFIRMED")
			...
			InitialSetup.test.log(LogStatus.PASS, "Successfully booked with: " + awb + " and UBR No: " + ubrNo);
			captureAndAddScreenshot();
			logger.info("Successfully booked with: " + awb + " and UBR No: " + ubrNo);

		} else {
			InitialSetup.test.log(LogStatus.FAIL, "VAILIDATION FAILURE: booked with: " + awb + "and UBR No: " + ubrNo
	...
	public CAP018 DGBookingwithPaymentCC(String prefix, String awbno, String origin, String dest, String agentCode,
		...
		PropertyHandler.setPropValue(dataFilePath, "carrierwithFlightno", carrierWithFlightno);
		click(btn_List);
		InitialSetup.test.log(LogStatus.INFO, "Booking has been started for the shipment");
		minWait();
		driver.switchTo().defaultContent();
		if (verifyElementPresent(info_msg)
				&& driver.findElement(info_msg).getText().trim().equals("AWB does not exist.Do you want to capture?")) {
		...
		click(btn_Popupadd);
		click(btn_PopupOK);
		InitialSetup.test.log(LogStatus.PASS, "Successfully filled details with UNID: " + UNIDNo);
		maxWait();
		try {
			handleAlert("Accept", "CAP018");
		} catch (Exception e) {
	...
	public CAP018 verifyUpdatedWeight(String awbPre, String awbNo, String newWt) {
		...
		if (actualValue.equals(newWt)) {
			InitialSetup.test.log(LogStatus.PASS, "Weight has been successfully updated in booking screen");
		} else {
			InitialSetup.test.log(LogStatus.FAIL, "Weight hasn't been updated in booking screen");
		}
	...
	public CAP018 temperatureCheckAndSave(String PopUpYesOrNo, String bookingStatus, String awbno) {
		...
		if (verifyElementPresent(info_msg)) {
			...
			if (PopUpYesOrNo.toLowerCase().equals("yes")) {
				click(btn_genericYes);
				InitialSetup.test.log(LogStatus.INFO, "Successfully clicked Yes on pop-up: " + popUp_message);
			} else {
				click(btn_noBtn);
				InitialSetup.test.log(LogStatus.INFO, "Successfully clicked No on pop-up: " + popUp_message);
	...
	public CAP018 simpleBookingwithoutULDandMultilegFLT1(String prefix, String awbno, String origin, String dest,
		...
		// enterKeys(txt_awbNo, awbno);
		click(btn_List);
		// InitialSetup.test.log(LogStatus.INFO, "Successfully entered Prefix
	...
	public CAP018 simpleBookingwithULDandMultilegFLT(String prefix, String awbno, String origin, String dest,
		 ...
		 * selectByText(list_dropDown_fltForce, forceStatus);
		 */
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered leg 1 flight Number: " + carrierWithFlightno);
		return this;
	}
...
//		enterKeys(getWebElements(list_txt_fltWt).get(legNo), wt);
	...
	public CAP018 simpleBooking1withoutULD(String prefix, String awbno, String origin, String dest, String agentCode,
		...
		list(prefix, awbno);
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered Prefix and AWB no in CAP018 screen: " + awbno);
		minWait();
		driver.switchTo().defaultContent();
		if (verifyElementPresent(info_msg)
				&& driver.findElement(info_msg).getText().trim().equals("AWB does not exist.Do you want to capture?")) {
	...
	public CAP018 saveInCAP018AndVerifyEmbargoRestriction() {
		...
		if (message.contains("Human Remains are not permitted to arrive on Saturday or Sunday")) {
			InitialSetup.test.log(LogStatus.PASS, "Cannot Do booking due to reason :  " + message);
		} else {
			InitialSetup.test.log(LogStatus.FAIL, "Booking Done");
	...
	public CAP018 ListAndVerifyBookingStatus(String awbPre, String awbNo, String UBRNo, String BookingStatus,
		...
		if (verifyElementPresent(info_msg)) {
			if (!(driver.findElement(info_msg).getText().trim().equals("AWB does not exist.Do you want to capture?"))) {
				...
				InitialSetup.test.log(LogStatus.FAIL, "Unable to list in CAP018");
		...
		if (ubrNumber == null) {
			InitialSetup.test.log(LogStatus.FAIL, "Booking has not been done with AWB: " + awbNo);
		...
		if (verifyBooking == true) {
			...
			if (bookStatus.equalsIgnoreCase(BookingStatus)) {
				InitialSetup.test.log(LogStatus.PASS, "Booking Status matches");
			} else {
				InitialSetup.test.log(LogStatus.FAIL, "Booking Status doesn't match");
				Assert.fail("Booking Status doesn't match");
			}
		}
		InitialSetup.test.log(LogStatus.INFO, "Booking Status: " + bookStatus + " and UBR No.: " + UBRNo);
	...
	public CAP018 verifyAllotment() {
		...
		if (!((Allot = driver.findElement(By.xpath("(//*[@name='allotmentId'])[1]")).getAttribute("value"))
			...
			InitialSetup.test.log(LogStatus.FAIL, "Booking has been done in FS");
	...
	public CAP018 VerifyRateDetailsinCAP018() {
		...
		if (totalcalc.equals(driver.findElement(By.xpath("//*[@id='grandTotal_LBL']")).getText())) {
			InitialSetup.test.log(LogStatus.PASS, "Total amount calculated is correct. Amount is: " + totalcalc);
	...
	public CAP018 simpleBookingWithoutULD(String prefix, String awbno, String origin, String dest, String agentCode,
		...
		try {
			if (!PropertyHandler.getPropValue(dataFilePath, "valueAdd").equals(null)
				...
				waitForFrameAndSwitch(screenFrame);
				maxWait();
				InitialSetup.test.log(LogStatus.INFO, "Updated booking with Value Added Service");
				captureAndAddScreenshot();
		...
		try {
			...
			if (validateScc != null && PropertyHandler.getPropValue(dataFilePath, "validateSCC").equals("Yes")) {
				...
				if (SCC.contains("BSX")) {
					InitialSetup.test.log(LogStatus.PASS, "BSX stamping has been done");
				} else {
					InitialSetup.test.log(LogStatus.FAIL, "BSX stamping hasn't been done");
				}
			}
		} catch (Exception e) {
		}
	...
	public CAP018 simpleBookingWithoutULDFirstLeg(String prefix, String awbno, String origin, String intermediate,
		 ...
		 * selectByText(list_dropDown_fltForce, "Confirm");
		 */
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered first leg details");
		return this;
	}
	...
	public CAP018 simpleBookingWithoutULDFirstLegOA(String prefix, String awbno, String origin, String intermediate,
		 ...
		 * selectByText(list_dropDown_fltForce, "Confirm");
		 */
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered leg1 flight as: " + carrierWithFlightno1);
		return this;
	}
	...
	public CAP018 simpleHVBookingWithoutULDCC(String prefix, String awbno, String origin, String dest, String agentCode,
		...
		InitialSetup.test.log(LogStatus.INFO, "Successfully Entered DV Amount:" + Dvamount + "\n\t" + "Insurance: "
				+ insurance + "\n\t" + "Customs: " + customs);
		 ...
		 * waitForFrameAndSwitch(screenFrame); } catch(Exception e){
		 * waitForFrameAndSwitch(screenFrame); }
		 * InitialSetup.test.log(LogStatus.PASS, "Checksheet for HVL Shipment");
		...
		if (allotmenttest == true) {
			...
			if (CapacityType.equals("Allotment")) {
				InitialSetup.test.log(LogStatus.PASS, "Capacity type is : " + CapacityType);
				InitialSetup.test.log(LogStatus.PASS, "Successfully booked with Allotment ID : " + AllotId);
			} else {
				InitialSetup.test.log(LogStatus.FAIL,
	...
	public CAP018 simpleBookingWithoutULDAVI(String prefix, String awbno, String origin, String dest, String agentCode,
		...
		try {
			...
			driver.switchTo().defaultContent();
			waitForFrameAndSwitch(screenFrame);
			InitialSetup.test.log(LogStatus.INFO, "Checksheet has been updated");
		} catch (Exception e) {
			InitialSetup.test.log(LogStatus.INFO, "No checksheet configured");
			logger.info("No checksheet configured");
		}
		/*
		 ...
		 * waitForFrameAndSwitch(screenFrame);
		 * InitialSetup.test.log(LogStatus.INFO, "Checksheet has been updated");
		 * }catch(Exception e){ InitialSetup.test.log(LogStatus.INFO,
		 * "No checksheet configured"); }
		 */
		click(btn_save);
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered values in Check Sheet for commodity: " + commCode);
		try {
			handleAlert("Accept", "CAP018");
			waitForFrameAndSwitch(screenFrame);
		} catch (Exception e) {
	...
	public CAP018 verifyReassignStatus(String prefix, String awbno, String flt2, String flt) {
		...
		if (actualvalue.equals(flt2)) {
			...
			InitialSetup.test.log(LogStatus.FAIL, "Reassigning the flight failed");
		...
		try {
			if (verifyNumberOfWindows(2)) {
				...
				if(verifyElementPresent(By.xpath("//input[1][@disabled]"))){
					InitialSetup.test.log(LogStatus.FAIL, "Failed due to embargo");
					Assert.fail();
				}
				// captureAndAddScreenshot();
			...
			InitialSetup.test.log(LogStatus.INFO, "Element not found" + e);
		} catch (Exception e) {
//			switchToFirstWindow();
			InitialSetup.test.log(LogStatus.INFO, "No Restriction applied for the commodity");
			logger.info("No Restriction applied for the commodity");
		}
		return this;
	}
	...
	public CAP018 verifySCCstamping(String prefix, String awbno, String expectedSCC, boolean listingreqd) {
		...
		if (SCC.contains(expectedSCC)) {
			InitialSetup.test.log(LogStatus.PASS, SCC + " stamping is successful");
			captureAndAddScreenshot();
		} else {
			InitialSetup.test.log(LogStatus.FAIL, SCC + " stamping failed");
			captureAndAddScreenshot();
		}
		return this;
	}
	...
	public CAP018 verifyAllotment(String prefix, String awbno) {
		...
		enterKeys(txt_awbNo, awbno);
		click(btn_List);
		InitialSetup.test.log(LogStatus.INFO, "Verifying Allotment");
		maxWait();
		maxWait();
		driver.switchTo().defaultContent();
		if (verifyElementPresent(info_msg)) {
		...
		if (allt.equalsIgnoreCase("Allotment")) {
			InitialSetup.test.log(LogStatus.PASS, "Allotment has been applied");
		} else {
			InitialSetup.test.log(LogStatus.FAIL, "Allotment hasn't been applied, applied capacity type is : " + allt);
		...
		captureAndAddScreenshot();
		InitialSetup.test.log(LogStatus.INFO, "Allotment applied here is : " + altid);
		return this;
	}
	...
	public CAP018 enterInitialBookingDetails(String origin, String dest, String agentCode, String Product, String pcs,
		 ...
		 * selectByText(list_dropDown_fltForce, forceStatus);
		 */
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered booking details");
		return this;
	}
	...
	public CAP018 spotRateUpdate(String prefix, String awbno) {
		...
		if (val != null) {
			InitialSetup.test.log(LogStatus.PASS, "Spot rate " + val + " has been attached");
		} else {
			InitialSetup.test.log(LogStatus.FAIL, "Spot Rate attachment failed");
		}
	...
	public CAP018 detachSpotRate(String prefix, String awbno) {
		...
		if (val.equals("") || val == null) {
			InitialSetup.test.log(LogStatus.PASS, "Spot rate " + val + " has been detached");
		} else {
			InitialSetup.test.log(LogStatus.FAIL, "Spot Rate detachment failed");
		}
		return this;
	}
	...
	public CAP018 enterValuesWithOneFltInCAP018(String prefix, String awbNo, String origin, String dest,
		...
		if (!(prefix.equalsIgnoreCase("001")))// not an AA AWB
		{
			...
			try {
				...
				InitialSetup.test.log(LogStatus.FAIL, "AWB for the OAL is not specified in the properties File");
				Assert.fail();
			}
		}
		click(btn_List);
		InitialSetup.test.log(LogStatus.INFO, "Clicked on list button");
		minWait();
		driver.switchTo().defaultContent();
		if (verifyElementPresent(info_msg)
				&& driver.findElement(info_msg).getText().trim().equals("AWB does not exist.Do you want to capture?")) {
		...
		InitialSetup.test.log(LogStatus.INFO, "Origin is: " + origin + " Destination is: " + dest);

		InitialSetup.test.log(LogStatus.INFO, "Successfully entered shipment details. Commodity is: " + commodityCode);
		if (isMultiLeg == true) {
		...
		scrollToView(list_dropDown_fltForce);
		// selectByText(list_dropDown_fltForce, forceStatus);
		InitialSetup.test.log(LogStatus.INFO, "Successfully entered flight details. Flight Number is: "
...
//			minWait();
			click(btn_Popupadd);
			click(btn_PopupOK);
			InitialSetup.test.log(LogStatus.PASS, "Successfully filled details with UNID: " + UDIDNo);
//			maxWait();
//			maxWait();
			switchBackToFirstWindow();
			waitForFrameAndSwitch(screenFrame);
	...
	public CAP018 TestDataCreationSaveDG(String index, String excelPath, String test) throws Exception {
			...
			if(verifyElementPresent(By.xpath("//td[@class='ic-error-msg']"))){
				...
				if(status.contains("UNID 1098 cannot be carried by Air")){
					InitialSetup.test.log(LogStatus.PASS, "Booking isnt created with status : "+status);
					captureAndAddScreenshot();
				}else{
					InitialSetup.test.log(LogStatus.FAIL, "Booking isnt created due to invalid reason");
				}
			}}
			else{
			driver.switchTo().defaultContent();
...
//				String msg = waitForElement(info_msg).getText();
			...
			PropertyHandler.setPropValue(dataFilePath, "awbNo", awb);
			int rowNoint = Integer.parseInt(index);
			writeAwbtoExcelCell(excelPath, rowNoint, "001-"+awb);
			InitialSetup.test.log(LogStatus.PASS, "Booking successfully done with and awb no is : "+ awb);
			captureAndAddScreenshot();
			}
...
//			enterKeys(txt_NetValue, DGwt);
			...
			click(By.name("dgVerifiedFlag"));
			minWait();
			InitialSetup.test.log(LogStatus.INFO, "Successfully added DG as all pack");
			captureAndAddScreenshot();
			maxWait();
			...
			click(btn_PopupOK);
			InitialSetup.test.log(LogStatus.PASS, "Successfully filled details with UNID");
//			maxWait();
//			maxWait();
			switchBackToFirstWindow();
			waitForFrameAndSwitch(screenFrame);
...
//	Sharath
	public CAP018 DGPackAllPropertyFile(int i, String pcs) throws Exception {
		...
		InitialSetup.test.log(LogStatus.PASS, "Successfully clicked on all pack button");
		captureAndAddScreenshot();
		maxWait();
		waitForFrameAndSwitch("popupContainerFrame");
...
//            enterKeys(list_txt_fltWt, wt);
            scrollToView(list_dropDown_fltForce);
          selectByText(list_dropDown_fltForce, "Confirm");
            InitialSetup.test.log(LogStatus.INFO, "Successfully entered Flight Number: "
                         + carrierWithFlightno);
            // DGR UNID
            click(btn_DGR);
            maxWait();
...
//            maxWait();
            ...
            InitialSetup.test.log(LogStatus.INFO, "Booking Status: " + waitForElement(info_bookingStatus).getAttribute(
                         "value"));
     ...
     /**
		...
		public CAP018 DGBookingwithTwoShipments(String prefix, String awbno, String origin, String dest,String agentCode,
				...
				String ubr, String commodityCode, String CarrierCode, String P1Value, String UDIDNo,String forceStatus,
				 String bookingStatus,String pieces1,String weight1,String totalpieces,String totalweight , String ShippingName) {
...
//			enterKeys(txt_commVol, volume);
		//	enterKeys(txt_shipmentDescrptn, "DAN");
			...
			try{
				enterKeys(By.xpath("(//input[@name='commodityCode'])[2]"),PropertyHandler.getPropValue(dataFilePath, "SpecialComcode"));
			}
			catch(Exception e)
			{}
			...
			click(btn_save);
			 //click(btn_save);
	          ...
	          //  String bookingStatus=PropertyHandler.getPropValue(dataFilePath, "bookingStatus");
	            ...
	            {
	            InitialSetup.test.log(LogStatus.PASS, "Successfully booked with: " + awb
	                         + "and UBR No: " + ubrNo);
	            }
	            else
	            {
	                  InitialSetup.test.log(LogStatus.FAIL, "VAILIDATION FAILURE: booked with: " + awb
	                                + "and UBR No: " + ubrNo+"\n"+"Booking Status doesn't match");
	            }
	            InitialSetup.test.log(LogStatus.INFO, "Booking Status: " + waitForElement(info_bookingStatus).getAttribute(
	                         "value"));
...
//	 		maxWait();
	 			...
	 			try {
	 				if (verifyNumberOfWindows(2)) {
	 					...
	 					maxWait();
	 					if(verifyElementPresent(By.xpath("//input[1][@disabled]"))){
	 						InitialSetup.test.log(LogStatus.INFO, "Restriction found");
	 						if(verifyElementPresent(By.xpath("//td[contains(text(),'Restricted')]"))){
	 							InitialSetup.test.log(LogStatus.PASS, "Restriction verified");
	 							captureAndAddScreenshot();
	 						}else{
	 							InitialSetup.test.log(LogStatus.FAIL, "Restriction not found");
	 							Assert.fail();
	 						}
	 					}
	 					else if(verifyElementPresent(By.name("btContinue"))) {
	 						InitialSetup.test.log(LogStatus.FAIL, "Restriction can be overriden");
	 						click(By.name("btContinue"));
	 					} 
	 				}
	 			} catch (Exception e) {
